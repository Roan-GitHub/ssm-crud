...
<table align="center" border=1 width=700px height=300px>
  <tr><td><br></td></tr>
 <tr>
 <th align="left">物流动态</th>
 </tr>
 <%
    String  dynamic_infotitle = (String)session.getAttribute("dynamic_info");
    String [] dytitle = dynamic_infotitle.split(",");
    for(int y=0; y<dytitle.length; y++)
    {
      out.print("<tr><td><a href='user_dynamic_info_show?dynamictitle="+dytitle[y]+"'>"+dytitle[y]+"</a></td></tr>");
    }
 %> 
 </table>
