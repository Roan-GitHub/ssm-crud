...
<table align="center" border=1 width=700px height=300px>
  <tr><td><br></td></tr>
 <tr>
 <th align="left">物流知识</th>
 </tr>
 <%
    String  logistics_knowledgetitle = (String)session.getAttribute("logistics_knowledge");
    String [] lgkt = logistics_knowledgetitle.split(",");
    for(int y=0; y<lgkt.length; y++)
    {
      out.print("<tr><td><a href='user_logistics_knowledge_show.action?knowtitle="+lgkt[y]+"'>"+lgkt[y]+"</a></td></tr>");
    }
 %> 
 </table>
