...
<table align="left" border=1 width=1000px> 
 ...
 <td>
 <s:form action="user_logistics_knowledge_insert" method="post">
 <table  border=1 width=800px  align="right"> 
 <tr><td width=100px></td><th width=120px align="center">添加物流知识信息</th><td></td></tr>  
 <tr><td align="center">标题</td><td><input type="text" name="logistics_knowledge.title"></td>    
 <tr><td align="center">备注</td><td><input type="text" name="logistics_knowledge.info"></td>    
 <tr><td><br></td></tr>
