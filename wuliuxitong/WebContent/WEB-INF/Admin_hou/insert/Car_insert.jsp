...
<table align="left" border=1 width=1000px> 
 ...
 <td>
 <s:form action="user_car_insert" method="post">
 <table  border=1 width=800px  align="right"> 
 <tr><td width=100px></td><th width=120px align="center">添加车辆信息</th><td></td></tr>  
 <tr><td align="center">载重</td><td><input type="text" name="car.capcity"></td>    
 <td align="center">发车地点</td><td><input type="text" name="car.start"></td></tr> 
 <tr><td align="center">备注</td><td><input type="text" name="car.info"></td>    
 <td align="center">发车时间</td><td><input type="text" name="car.date"></td></tr> 
 <tr><td><br></td></tr>
