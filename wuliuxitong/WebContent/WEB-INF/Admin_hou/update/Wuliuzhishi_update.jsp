...
<table align="left" border=1 width=1000px> 
 ...
 <td>
 <%
    String logistics_knowledge_update_message = (String)session.getAttribute("logistics_knowledge_update_message");
    String [] lgkl_update = logistics_knowledge_update_message.split(",");
 %>
 <s:form action="user_logistics_knowledge_update" method="post">
 <table  border=1 width=800px  align="right"> 
 <tr><td width=100px></td><th width=120px align="center">修改物流知识信息</th><td></td></tr>  
 <tr><td align="center">标题</td><td><input type="text" name="logistics_knowledge.title" value=<%= lgkl_update[0] %>></td>    
 <tr><td align="center">备注</td><td><input type="text" name="logistics_knowledge.info" value=<%= lgkl_update[1] %>></td>
 <tr><td><br><input type="hidden" name="logistics_knowledge.id" value=<%= lgkl_update[2] %>></td></tr>        
 <tr><td><br></td></tr>
