...
<table align="left" border=1 width=1000px> 
 ...
 <td>
 <%
    String dynamic_info_update_message = (String)session.getAttribute("dynamic_info_update_message");
    String [] dnfo_update = dynamic_info_update_message.split(",");
 %>
 <s:form action="user_dynamic_info_update" method="post">
 <table  border=1 width=800px  align="right"> 
 <tr><td width=100px></td><th width=120px align="center">修改物流动态信息</th><td></td></tr>   
 <tr><td align="center">标题</td><td><input type="text" name="dynamic_info.title" value=<%= dnfo_update[0] %>></td>    
 <tr><td align="center">备注</td><td><input type="text" name="dynamic_info.info" value=<%= dnfo_update[1] %>></td>
 <tr><td><br><input type="hidden" name="dynamic_info.id" value=<%= dnfo_update[2] %>></td></tr>     
 <tr><td><br></td></tr> 
