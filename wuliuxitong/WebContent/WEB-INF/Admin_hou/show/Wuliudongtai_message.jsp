...
<table align="left" border=1 width=1000px> 
 ...
 <table  border=1 width=850px  align="center">
  <tr><th align="center"><a href="user_dynamic_info_insert_jsp.action">添加物流动态</a></th></tr>
 <tr><th>id</th> <th>标题</th> <th>发布时间</th> <th>备注</th> <th>编辑</th> <th>删除</th></tr> 
 <%
    String dynamic_info_message = (String)session.getAttribute("dynamic_info_message");
    String [] dynamic_info_row = dynamic_info_message.split(";");
    for(int i=0; i <dynamic_info_row.length; i++)
    {
    	String [] dynamic_info_count = dynamic_info_row[i].split(",");
    	out.print("<tr>");
    	for(int j=0; j < dynamic_info_count.length; j++)
    	{
    		out.print("<td>"+dynamic_info_count[j]+"</td>");
    	}
    	out.print("<td><a href='user_dynamic_info_update_jsp?dynamic_info_id="+dynamic_info_count[0]+"'>编辑</a></td>"+"<td><a href='user_dynamic_info_delete?dynamic_info_id="+dynamic_info_count[0]+"'>删除</a></td>"+"</tr>");
    }       
 %>   
 <%
