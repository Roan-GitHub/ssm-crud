...
<table align="left" border=1 width=1000px> 
 ...
 <tr><th align="center"><a href="user_notice_insert_jsp.action">添加公告信息</a></th></tr>
 <tr><th>id</th> <th>标题</th> <th>发布时间</th> <th>备注</th> <th>编辑</th> <th>删除</th></tr> 
 <%
    String notice_message = (String)session.getAttribute("notice_message");
    String [] notice_row = notice_message.split(";");
    for(int i=0; i <notice_row.length; i++)
    {
    	String [] notice_count = notice_row[i].split(",");
    	out.print("<tr>");
    	for(int j=0; j < notice_count.length; j++)
    	{
    		out.print("<td>"+notice_count[j]+"</td>");
    	}
    	out.print("<td><a href='user_notice_update_jsp?notice_id="+notice_count[0]+"'>编辑</a></td>"+"<td><a href='user_notice_delete?notice_id="+notice_count[0]+"'>删除</a></td>"+"</tr>");
    } 
 %>
 <%
