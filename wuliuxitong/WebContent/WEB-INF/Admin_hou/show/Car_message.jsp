...
<table align="left" border=1 width=1000px> 
 ...
 <table  border=1 width=850px  align="center">
  <tr><th align="center"><a href="user_car_insert_jsp.action">添加车辆信息</a></th></tr>
 <tr><th>id</th> <th>载重</th> <th>发车地点</th> <th>备注</th> <th>发车时间</th> <th>编辑</th> <th>删除</th></tr> 
 <%
    String car_message = (String)session.getAttribute("car_message");
    String [] car_row = car_message.split(";");
    for(int i=0; i <car_row.length; i++)
    {
    	String [] car_count = car_row[i].split(",");
    	out.print("<tr>");
    	for(int j=0; j < car_count.length; j++)
    	{
    		out.print("<td>"+car_count[j]+"</td>");
    	}
    	out.print("<td><a href='user_car_update_jsp?car_id="+car_count[0]+"'>编辑</a></td>"+"<td><a href='user_car_delete?car_id="+car_count[0]+"'>删除</a></td>"+"</tr>");
    }
 %>
 <%
